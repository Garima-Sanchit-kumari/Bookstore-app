        ...
        <div className="w-[600px]">
            <div className="modal-box">
                <form  onSubmit={handleSubmit(onSubmit)} method="dialog">
                    ...
                    <Link to="/" className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 text-purple-500">✕</Link>
                
                <h3 className="font-bold text-lg text-pink-500">Signup</h3>
                 {/*name*/}
                <div className='mt-4 space-y-2 text-purple-500'>
                    <span>Name</span>
                    <br />
                    <input type="text" name="" id="" placeholder='Enter your fullname' className='w-80 px-3 py-1 border rounded-md outline-none'
